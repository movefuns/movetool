        ...
        <Card sx={{ minWidth: 275 }}>
            <CardContent>
                ...
                <Typography variant="h5" component="div">
                    Starcoin  {t("menu.chain_record")}   <Button variant="outlined"  onClick={handleQuery}>{t("chain_record.query_record")}</Button>
                </Typography>
                ...
                }} fullWidth id="outlined-basic" label={t("chain_record.stc_amount")} variant="outlined" value={amount} />
